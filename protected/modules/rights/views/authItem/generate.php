...
/*
	...
	*/
    ...
    Rights::t('core', 'Rights') => array('/rights/authItem/permissions'),
    Rights::t('core', 'Generate items'),
    );
...
<div id="generator">
	...
	<h1 class="page-header" ><?php echo Rights::t('core', 'Generate items'); ?></h1>
   			...
   			<div class="row">
   				...
   				<?php
					$this->widget(
						    ...
						    array('buttonType' => 'submit', 'label' => 'Generate')
						);
					?>
